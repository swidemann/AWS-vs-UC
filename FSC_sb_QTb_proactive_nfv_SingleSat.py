...
try:
    ...
    formato = "formato: <modelo.py> <instance> <show or noshow> <var: 10,30,50> air<# airports> <consolidate> <Lmethod> <hours> <vicinity_n> <NS or reset> <satellite: partial or full> <Qout or noQout>"
    print(formato)
    sys.exit()
...
if partial:
    model_name = 'FSC sb QTb proactive {}-fv SingleSat partial {} i-{}'.format(vicinity_n, L_method, instance)
else:
    model_name = 'FSC sb QTb proactive {}-fv SingleSat {} i-{}'.format(vicinity_n, L_method, instance)
