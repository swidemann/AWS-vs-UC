...
from Improvements_functions import calculate_transf_cost, check_best_bound
import sys
...
line = "Cuts added: Integer QTbound reactive"
print("\n*** {} ***".format(line))
...
if partial:
    model_name = 'FSC sb QTb reactive SingleSat partial {} i-{}'.format(L_method, instance)
else:
    model_name = 'FSC sb QTb reactive SingleSat {} i-{}'.format(L_method, instance)
